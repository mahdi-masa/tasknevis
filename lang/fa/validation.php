...
return [
   ...
   'attributes' => [
      ...
      "input.email" => "پست الکترونیکی",
      "input.first_name" => "نام",
      "input.last_name" => "نام خانوادگی",
      "input.family" => "نام خانوادگی",
      "input.password" => "رمز عبور",
      "input.password_confirmation" => "تاییدیه ی رمز عبور",
      "input.city" => "شهر",
      "input.province" => "استان",
      "input.country" => "کشور",
      "input.address" => "نشانی",
      "input.phone" => "تلفن",
      "input.mobile" => "تلفن همراه",
      "input.age" => "سن",
      "input.sex" => "جنسیت",
      "input.gender" => "جنسیت",
      "input.birthday" => "تاریخ تولد",
      "input.birthdate" => "تاریخ تولد",
      "input.married" => "متاهل",
      "input.single" => "مجرد",
      "input.day" => "روز",
      "input.month" => "ماه",
      ...
      "input.text" => "متن",
      "input.content" => "محتوا",
      "input.description" => "توضیحات",
      "input.excerpt" => "گلچین کردن",
      "input.date" => "تاریخ",
      "input.time" => "زمان",
      "input.available" => "موجود",
      "input.size" => "اندازه",
      "input.volume" => "حجم",
      "input.file" => "فایل",
      "input.fullname" => "نام کامل",
      "input.melli_code" => "کد ملی",
      "input.national_number" => "کد ملی",
      "input.postal_code" => "کد پستی",
      "input.zip_code" => "کد پستی",
      "input.passport_number" => "شماره پاسپورت",
      "input.passport_no" => "شماره پاسپورت",
      "input.sheba_number" => "شماره شبا",
      "input.iban" => "شماره شبا",
      "input.accountـnumber" => "شماره حساب"
   ],
];
